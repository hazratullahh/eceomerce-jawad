...
export default function CustomerTable({
  ...
  const itemsPerPage = 10; // Still customizable
  ...
  return (
    <div className="bg-gray-800 rounded-xl shadow-xl overflow-hidden border border-gray-700">
      {/* Ensures the table itself scrolls if content is too wide */}
      <div className="overflow-x-auto">
        {isLoading && !isFetching ? (
          <div className="flex flex-col items-center justify-center py-16 text-gray-400">
            <FaSpinner className="animate-spin text-5xl mb-4" />
            <p className="text-xl font-semibold">Loading customers...</p>
          ...
          <div className="flex flex-col items-center justify-center py-16 text-red-500">
            ...
            <p className="text-base mt-3">
              Error: {error?.message || "Could not load customer data."}
            </p>
                  ...
                  currentCustomers.map((customer, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-300 text-center sm:px-6">
                          ${customer.amountWillPay?.toFixed(2) || "0.00"}
                        </td>
                        <td className="px-4 py-3 whitespace-nowrap text-sm text-gray-300 text-center sm:px-6">
                        ...
                        <td className="px-4 py-3 whitespace-nowrap text-sm font-medium text-center sm:px-6">
                          <button
